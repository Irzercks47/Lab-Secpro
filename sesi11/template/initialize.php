...
if(!$initialized || $force){
    ...
    $tables = "4 tables (users, app_config, posts, comments)";    
    ...
    $insert_tables = [
        "INSERT INTO `users` (`fullname`, `username`, `email`, `password`) VALUES (?, ?, ?, SHA1(?))",
    ...
    $dummy_users = [
        [ "ssss", "Dummy 1", "dummy1", "dummy1@dummy.com", "dummy1dummy1" ],
        [ "ssss", "Dummy 2", "dummy2", "dummy2@dummy.com", "dummy2dummy2" ],
        [ "ssss", "Dummy 3", "dummy3", "dummy3@dummy.com", "dummy3dummy3" ],
	];
    ...
    $dummy_posts = [
        [ "ssi", "Hello World", "2018-12-27 15:33:10", 1 ],
        [ "ssi", "Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate laborum nesciunt ipsam neque fugiat enim dignissimos labore obcaecati, eveniet corrupti incidunt tenetur saepe blanditiis vel perferendis quaerat accusamus eum vitae.", "2018-12-27 15:34:10", 2 ],
        [ "ssi", "Good Morning!", "2018-12-28 07:35:10", 3 ],
	];

    // Generate dummy comments
    $dummy_comments = [
        [ "ssii", "What are you talking about?", "2018-12-27 18:20:12", 2, 3 ],
        [ "ssii", "Morning!", "2018-12-28 08:03:23", 3, 2 ],
        [ "ssii", "Morning too!", "2018-12-28 08:31:13", 3, 1 ],
	];

    $initialize_datas = [
        [ $insert_tables[0], $dummy_users ],
        [ $insert_tables[1], $app_config_value ],
        [ $insert_tables[2], $dummy_posts ],
        [ $insert_tables[3], $dummy_comments ],
    ];
    ...
    echo(create_report("Table Seeder Report", [
        ...
        "Post entered (". count($dummy_posts) . " data(s))", 
        "Comment entered (". count($dummy_comments) . " data(s))", 
    ]));
    ...
    echo(create_report("Initialization Completed", [
        "You can log in with this credential (username/password): $username/$password",
